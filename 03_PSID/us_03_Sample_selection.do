...
Author:  Konrad Turek
Date:    06.2025
Input:   us_02.dta (harmonized dataset)
Output:  us_03.dta (selected sample)
===============================================================================
*/

* Log
capture log close 
log using "${psid_out}/us_03_sample_selection.log", replace
display "Starting PSID sample selection at $S_TIME"


**--------------------------------------
** Data
**--------------------------------------
use "${psid_out}/us_02.dta" , clear
...
* Log close
display "Completed PSID sample selection at $S_TIME"
log close
