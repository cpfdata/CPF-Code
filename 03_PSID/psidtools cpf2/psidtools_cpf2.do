...
* USER version CPF 2.0 - adjusted to work with wave 2023
...
program _SET_DELIVERY, rclass
	...
	local stop 2023 // CPF 2.0 changed to '2023' 
	while `stop' > 1968 {
	...
	local idind ///
	  ...
	  [19] `er'34701 [21] `er'34901 [23] `er'35101	// CPF 2.0 added [23]
	...
	local idfam ///
	  ...
	  [21] `er'78002 [23] `er'82002 // CPF 2.0 added  [23]
	...
	local sqind ///
	  ...
	  [13] `er'34202 [15] `er'34302 [17] `er'34502 [19] `er'34702 [21] `er'34902 [23] `er'35102 // CPF 2.0 added [23]
