...
- Add variable and value labels to the CPFvX.dta file
Input:  CPFvX.dta
Output: CPFvX.dta (with variable and value labels)
===============================================================================
Author:  Konrad Turek
Date:    07.2025
===============================================================================
...
lab var mater "Currently on parental leave"
...
// lab var inctot_pyg "Individual Income (All types, prev. year, gross)"
// lab var inctot_pyn "Individual Income (All types, prev. year, net)"
// lab var inctot_cyn "Individual Income (All types, curr. year, net)"
// lab var inctot_cyg "Individual Income (All types, curr. year, gross)"
...
// lab var incjobs_cyn "Individual Labor Earnings (All jobs, curr. year, net)"
lab var incjobs_cyg "Individual Labor Earnings (All jobs, curr. year, gross)"
...
// lab var incjob1_pyn 	"Salary from main job (prev. year, net)"
lab var incjob1_cyn 	"Salary from main job (curr. year, net)"
lab var incjob1_cyg 	"Salary from main job (curr. year, gross)"
...
lab var hhinc_pypre "HH income(prev. month, pre)"
lab var hhinc_pypost "HH income(prev. month, post)"
lab var hhinc_pypost_eq "HH income(prev. month, post, equivalized)"
//lab var hhinc_pypost_eq_UK "HH income(prev. year, post, equivalized) [UK]"
...
lab def country 1 "[1] Australia" 2 "[2] Korea" 3 "[3] USA" 4 "[4] Russia" ///
				5 "[5] Switzerland" 6 "[6] Germany" 7 "[7] UK" 8 "[8] Netherlands" , replace

lab def respstat 	1 "Interviewed" 					///
					2 "Not interviewed (has values)" 	///
					3 "Not interviewed (no values)", replace
					
lab def female 0 "Male" 1 "Female" 2 "Other/No answer" , replace
...
lab def fptime 1 "Full-time" 2 "Part-time/irregular" 3 "Not empl/0 hours/other", replace
lab def srh5 5 "Poor" 4 "Fair" 3 "Good" 2 "Very good" 1 "Excellent", replace
