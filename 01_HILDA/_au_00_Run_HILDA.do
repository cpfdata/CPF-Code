...
===============================================================================
>> CPF Version 2.0 
File: "_11a_Run_HILDA.do"
Purpose: Run HILDA (Australia) specific do-files
===============================================================================
*/

clear
di  _newline "### CPF: Preparing data for HILDA (Australia) ###"
di "Starting at time: $S_TIME"
di  "Preparing CPF datafile for HILDA based on do-files in:"
cd "${your_dir}/11_CPF_in_syntax/01_HILDA/"
...
di "->> CPF version ${cpfv} of HILDA saved"
qui tab wave
di "->> Variables: " c(k) "; N: " _N "; Waves: " r(r)
di "Finished the code for [HILDA]. At time:$S_TIME"
