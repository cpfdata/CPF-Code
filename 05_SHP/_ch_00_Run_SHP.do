...
===============================================================================
>> CPF Version 2.0 
File: "_11d_Run_SHP.do"
Purpose: Run SHP (Switzerland) specific do-files
===============================================================================
*/

clear
di  _newline "### CPF: Preparing data for SHP (Switzerland) ###"
di "Starting at time: $S_TIME"
di  "Preparing CPF datafile for SHP based on do-files in:"

local data "shp"
cd "${your_dir}/11_CPF_in_syntax/05_SHP/"
...
di "->> CPF version ${cpfv} of SHP saved"
qui tab wave
di "->> Variables: " c(k) "; N: " _N "; Waves: " r(r)
di "Finished the code for [SHP]. At time:$S_TIME"
