...
CPF Version 2.0 
SHP 
Syntax 02_2: Harmonize variables - long file for waves	
===============================================================================
Purpose: Harmonize variables in SHP-waves file (all waves combined)
Author:  Konrad Turek
Date:    06.2025
Input:   ch_01_selected_long.dta 
Output:  ch_02b_wave.dta 
===============================================================================
*/
...
* Log
capture log close 
log using "${shp_out}/ch_02_2_preparation.log", replace
...
*################################################################################	
*#							
*#	Labour market situation: employment status, occupation, industry, sector, size	
*#							
*################################################################################	
...
*################################################################################	
*#							
*#	Work-related variables: hours, overtime, supervisor, work-type	
*#							
*################################################################################	
...
*################################################################################	
*#							
*#	Employment status: self-employed / entrepreneur	
*#							
*################################################################################	
**--------------------------------------
** Self-imployed	 
...
*################################################################################	
*#							
*#	Other variables: training, work-edu link, volunteering, job security				
*#							
*################################################################################	
**--------------------------------------
**   Training
...
*** Father 
*edu3
recode p__o17 (0/1=1)(2/4 5 6/8 18=2)(12/17 =3) (32=-1), gen(fedu3)
...
* edu4
recode p__o17 (0=1)(1=2)(2/4 5 6/8 18=3)(12/17 =4)(32=-1) , gen(fedu4)
...
*** Mother 
*edu3
recode p__o34 (0/1=1)(2/4 5 6/8 18=2)(12/17 =3) (32=-1), gen(medu3)
...
* edu4
recode p__o34 (0=1)(1=2)(2/4 5 6/8 18=3)(12/17 =4)(32=-1) , gen(medu4)
...
**--------------------------------------
**   Country of birth: respondent, father and mother
**--------------------------------------	
...
do "${Gdr_syntax}/05_SHP/ch_02add_labels_COB.do" 
...
recode p_r04 (1/3=1) (4/5=2) (6/7=3) (8/9=4) (-3=-3) (-2=-2) (-1 -3=-1), gen(relig_att)
