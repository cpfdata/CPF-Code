...
===============================================================================
>> CPF Version 2.0 
File: "_11b_Run_KLIPS.do"
Purpose: Run KLIPS (Korea) specific do-files
===============================================================================
*/

clear
di  _newline "### CPF: Preparing data for KLIPS (Korea) ###"
di "Starting at time: $S_TIME"
di  "Preparing CPF datafile for KLIPS based on do-files in:"
cd "${your_dir}/11_CPF_in_syntax/02_KLIPS/"
...
di "->> CPF version ${cpfv} of KLIPS saved"
qui tab wave
di "->> Variables: " c(k) "; N: " _N "; Waves: " r(r)
di "Finished the code for [KLIPS]. At time:$S_TIME"
