...
===============================================================================
>> CPF Version 2.0 
File: "_11g_Run_LISS.do"
Purpose: Run LISS (Netherlands) specific do-files
===============================================================================
*/

clear
di  _newline "### CPF: Preparing data for LISS (Netherlands) ###"
di "Starting at time: $S_TIME"
di  "Preparing CPF datafile for LISS based on do-files in:"
cd "${your_dir}/11_CPF_in_syntax/08_LISS/"
...
di "->> CPF version ${cpfv} of LISS saved"
qui tab wave
di "->> Variables: " c(k) "; N: " _N "; Waves: " r(r)
di "Finished the code for [LISS]. At time:$S_TIME"
