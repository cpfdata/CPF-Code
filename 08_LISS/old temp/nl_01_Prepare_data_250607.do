...
Author:  Konrad Turek
Date:    06.2025
Input:   liss{w}p.dta, liss{w}h.dta files
Output:  nl_01.dta (combined person-household file)
===============================================================================
*/
* Log
capture log close 
...
*################################################################################
*#
*# Step 6: Cleaning the merged datafile 
*#
*############################
/*
!!!! TO DO if necessary

*** Delete cases with no observations 
...
bro nohouse_encr wavey nmissing nvalid temp*/

*** Additional file - all months sequence 
