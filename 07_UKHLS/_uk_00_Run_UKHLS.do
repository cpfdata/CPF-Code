...
===============================================================================
>> CPF Version 2.0 
File: "_11f_Run_UKHLS.do"
Purpose: Run UKHLS (UK) specific do-files
===============================================================================
*/

clear
di  _newline "### CPF: Preparing data for UKHLS (UK) ###"
di "Starting at time: $S_TIME"
di  "Preparing CPF datafile for UKHLS based on do-files in:"
cd "${your_dir}/11_CPF_in_syntax/07_UKHLS/"
...
di "->> CPF version ${cpfv} of UKHLS saved"
qui tab wave
di "->> Variables: " c(k) "; N: " _N "; Waves: " r(r)
di "Finished the code for [UKHLS]. At time:$S_TIME"
